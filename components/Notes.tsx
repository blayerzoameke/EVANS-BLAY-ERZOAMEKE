                ...
                <div className="flex-1 overflow-y-auto">
                    {filteredNotes.map(note => (
                        <div
                            ...
                            className={`p-4 cursor-pointer border-l-4 ${currentNote?.id === note.id ? 'bg-indigo-50 dark:bg-indigo-900/30 border-indigo-500' : 'border-transparent hover:bg-gray-100 dark:hover:bg-gray-800'}`}
                        >
                 ...
                 <div className="p-2 border-t dark:border-gray-700">
                    <button onClick={createNewNote} className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700">
                ...
                {currentNote ? (
                    <>
                        <div className="p-4 border-b dark:border-gray-700 flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button onClick={() => deleteNote(currentNote.id)} className="p-2 text-gray-400 hover:text-red-500 rounded-full">
                    ...
                    <div className="flex items-center justify-center h-full text-center text-gray-500 dark:text-gray-400">
                        <div>
                            ...
                            <button onClick={createNewNote} className="text-indigo-600 dark:text-indigo-400 hover:underline">create a new one</button>
                        </div>
                    </div>
                )}
            </div>
