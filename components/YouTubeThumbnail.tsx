...
const YouTubeThumbnail: React.FC<YouTubeThumbnailProps> = ({ videoUrl, className = '' }) => {
    ...
    return (
        ...
        >
            ...
            {/* Click to Play Text */}
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-black/70 text-white px-4 py-2 rounded-full text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                Click to play
            </div>
        </div>
    );
